 ...
 */
final class Version20190907181900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE work_projects_task_changes (id INT NOT NULL, task_id INT NOT NULL, actor_id UUID DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, set_project_id UUID DEFAULT NULL, set_name VARCHAR(255) DEFAULT NULL, set_content TEXT DEFAULT NULL, set_file_id UUID DEFAULT NULL, set_removed_file_id UUID DEFAULT NULL, set_type VARCHAR(16) DEFAULT NULL, set_status VARCHAR(255) DEFAULT NULL, set_progress SMALLINT DEFAULT NULL, set_priority SMALLINT DEFAULT NULL, set_parent_id INT DEFAULT NULL, set_removed_parent BOOLEAN DEFAULT NULL, set_plan TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, set_removed_plan BOOLEAN DEFAULT NULL, set_executor_id UUID DEFAULT NULL, set_revoked_executor_id UUID DEFAULT NULL, PRIMARY KEY(task_id, id))');
        ...
        $this->addSql('COMMENT ON COLUMN work_projects_task_changes.task_id IS \'(DC2Type:work_projects_tasks_id)\'');
        ...
        $this->addSql('COMMENT ON COLUMN work_projects_task_changes.set_type IS \'(DC2Type:work_projects_tasks_type)\'');
        $this->addSql('COMMENT ON COLUMN work_projects_task_changes.set_status IS \'(DC2Type:work_projects_tasks_status)\'');
        $this->addSql('COMMENT ON COLUMN work_projects_task_changes.set_parent_id IS \'(DC2Type:work_projects_tasks_id)\'');
