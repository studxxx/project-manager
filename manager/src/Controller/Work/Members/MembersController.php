...
use App\Model\Work\UseCase\Mebers\Member\Create;
use App\Model\Work\UseCase\Mebers\Member\Edit;
use App\Model\Work\UseCase\Mebers\Member\Move;
...
class MembersController extends AbstractController
{
     ...
     * @return Response
     */
    public function index(Request $request, MemberFetcher $members): Response
    {
        $filter = new Filter\Filter();
        $form = $this->createForm(Filter\Form::class, $filter);
        $form->handleRequest($request);

        $pagination = $members->all(
            $filter,
