...
class Set
{
    ...
    /**
     * @var Type|null
     * @ORM\Column(type="work_projects_tasks_type", length=16, nullable=true)
     */
    private $type;
    /**
     * @var Status|null
     * @ORM\Column(type="work_projects_tasks_status", nullable=true)
     */
    private $status;
    /**
     * @var int|null
    ...
    /**
     * @var TaskId|null
     * @ORM\Column(type="work_projects_tasks_id", nullable=true)
     */
    private $parentId;
    /**
     * @var bool|null
    ...
    public static function forNewTask(
        ProjectId $project,
        string $name,
        ?string $content,
        Type $type,
